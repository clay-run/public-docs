...
-   **Past experiences:** Enable the **Include past experiences** toggle to extend your company, job title, and experience description keyword filters to also match against a person's past roles — not just their current one. See [Find people who previously worked at a specific company](finding-companies-and-people-in-clay.md#find-people-who-previously-worked-at-a-specific-company) for a common use case.
