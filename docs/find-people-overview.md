...
-   **Exclude people:** Exclude up to 3 different sets of people from your search using Clay tables, CSVs, or manual lists. You can exclude up to 300,000 people total (100,000 per source). Exclusions match by individual LinkedIn URL — each row in your exclusion table must contain the person's LinkedIn profile URL. Adding a company name, domain, or company LinkedIn URL to the exclusion table will **not** suppress all people from that company.
