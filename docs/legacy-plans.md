...
last_synced: 2026-09-16T16:01:37.519Z
---
...
In March 2026, Clay introduced a new pricing model to give you more flexibility and value. The new model uses two simple usage meters: **Actions** (for running workflows and automations) and **Data credits** (for accessing data from our marketplace).
...
Legacy Starter, Explorer, and Pro plans include a set of features built for modern plans at no extra cost, through December 31, 2026. They're switched on for you, so there's nothing to set up.
