...
**Repositioning the Sculptor panel:** By default, Sculptor opens as a docked panel attached to the side of your screen. To move it to a floating panel you can place anywhere on screen, click **Pop out chat** in the Sculptor panel header. While floating, drag the panel using the grip in the header, or press the arrow keys for precise movement. Click **Dock chat** to return it to the docked position.
