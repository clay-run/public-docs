...
-   Rows that were already run in the sandbox are automatically copied to the production table when you publish — so you don't need to re-run those rows or spend credits twice.
