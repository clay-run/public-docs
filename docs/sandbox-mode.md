...
-   When you publish (with either option), the rows you ran in your sandbox are automatically copied back to the matching rows in your production table — so you don't need to re-run them and won't be charged credits twice for the same work.
