...
**Note:** When you publish, any rows you already ran in your sandbox are automatically copied to your production table — so those rows reflect their enrichment results without needing to be re-run. This saves credits by avoiding duplicate enrichment charges on rows you already tested in sandbox.
