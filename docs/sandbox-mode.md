...
**Note:** When you publish, the results from rows you already ran in your sandbox are automatically applied to those same rows in the production table — so you don't need to re-run them and spend credits twice.
