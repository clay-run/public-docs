...
-   Data that was already run in your sandbox is automatically copied to the corresponding rows in your production table when you publish — so you won't need to re-run those rows and spend credits twice.
