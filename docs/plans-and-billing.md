...
-   **Set up automatic top-ups** — workspace admins can configure automatic credit purchases in `Settings` → `Usage` so credits are purchased whenever your balance runs low.
