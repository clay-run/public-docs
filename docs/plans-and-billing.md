...
last_synced: 2026-09-14T17:35:18.199Z
---
...
-   **Set up automatic top-ups** — Workspace admins can configure automatic top-ups in `Settings` → `Usage`: credits are purchased automatically whenever your balance drops below a threshold you set. Available on paid plans.
