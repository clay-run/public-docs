...
Follow these steps to set up News & Fundraising Signals in your workbook:

1.  Click `+ Add` in the bottom navigation bar of your workbook, then under **Signals** select **News & fundraising**.
