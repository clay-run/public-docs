...
description: Install the Clay Agent Plugin and use the CLI and Public API to run searches, call enrichment functions, and build Workflows from coding agents, terminals, and backend systems.
last_synced: 2026-09-15T18:32:57.399Z
---
