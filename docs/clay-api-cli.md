...
description: Install the Clay Plugin to run searches, call enrichment functions, and build Workflows programmatically from coding agents, terminals, and backend systems via the CLI and Public API.
last_synced: 2026-09-16T20:19:59.946Z
---
