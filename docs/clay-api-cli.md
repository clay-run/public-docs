...
description: Install the Clay Agent Plugin to run searches, call enrichment functions, and build Workflows programmatically from coding agents, terminals, and backend systems via the CLI and Public API.
last_synced: 2026-09-15T15:07:30.796Z
---
