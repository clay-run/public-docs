---
title: Clay API & CLI
description: Use Clay's Agent Plugin to access data, run searches, call enrichment functions, and build Workflows programmatically via the CLI and Public API.
last_synced: 2026-09-08T17:36:32.056Z
---
