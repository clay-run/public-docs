---
title: Clay API & CLI
description: How to access Clay's data and enrichments programmatically using the Clay CLI and Public API, including setup, plan limits, and available features.
last_synced: 2026-07-09T18:04:07.240Z
---
