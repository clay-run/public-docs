...
description: Install and use the Clay Agent Plugin to run searches, call enrichment functions, and build Workflows programmatically via the CLI or Public API from any coding agent or backend system.
last_synced: 2026-09-15T18:32:57.403Z
---
