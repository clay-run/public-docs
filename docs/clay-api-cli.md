---
title: Clay API & CLI
description: Access Clay's data and enrichments programmatically with the Clay CLI and Public API without using the UI.
last_synced: 2026-07-31T19:05:11.097Z
---
...
or tell any coding agent to "`Set up the Clay plugin by following the steps in <https://github.com/clay-run/agent-plugins>"`
