...
description: Install the Clay Agent Plugin and use the API and CLI to run Clay programmatically from coding agents, terminals, and backend systems.
last_synced: 2026-09-15T15:07:30.774Z
---
