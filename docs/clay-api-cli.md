...
description: Install and use Clay's plugin, API, and CLI to run searches, call enrichment functions, and build workflows programmatically from coding agents, terminals, and backend systems.
last_synced: 2026-09-16T20:19:59.952Z
---
