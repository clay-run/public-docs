---
title: Clay API & CLI
description: Programmatically access Clay's data and enrichments using the CLI and Public API without working in the UI.
last_synced: 2026-09-08T17:36:32.053Z
---
