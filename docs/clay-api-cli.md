...
description: How to install the Clay Agent Plugin on Mac or Windows (Claude Code or Codex), connect it to your workspace, and an overview of what the API and CLI support across plans.
last_synced: 2026-09-22T21:46:44.806Z
---
...
-   **The browser shows an error on `localhost` after you click `Authorize`** — usually a corporate VPN. Sign in with `clay login --device` instead (see below).
