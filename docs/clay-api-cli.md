...
description: Install the Clay Agent Plugin to use Clay programmatically via the CLI and Public API from coding agents, terminals, and backend systems.
last_synced: 2026-09-16T05:46:05.893Z
---
