...
description: How to install the Clay Plugin and connect it to your workspace on Mac or Windows to use Clay's CLI and Public API from coding agents and terminals.
last_synced: 2026-09-22T21:43:01.380Z
---
...
-   **The browser shows a localhost connection error after you click `Authorize`** — usually a corporate VPN. Sign in with `clay login --device` instead (see below).
