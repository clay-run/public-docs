...
description: Common questions and best practices for using Clay Audiences, including when to use Audiences vs. tables, how matching works, and setup guidance.
last_synced: 2026-06-23T21:35:42.252Z
---
...
Clay automatically deduplicates records across sources using a priority-ordered list of identifiers. For people records, Clay matches on: **professional network URL**, then **email**, then **phone**, then **name + state**. For company records, Clay matches on: **domain**, then **professional network URL**.
