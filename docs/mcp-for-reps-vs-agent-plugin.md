...
description: Explains when to use MCP for Reps versus the Clay Agent Plugin — who each surface is built for, governance differences, and key limitations.
last_synced: 2026-09-15T15:07:09.647Z
---
