...
-   State how many contacts you want and which fields to return — for example, "return up to 10 people with their name, title, profile URL, location, and work email"
