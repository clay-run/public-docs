...
Clay Lookalikes replaces Ocean.io's lookalike enrichments and sources. Ocean.io's lookalike features have been deprecated and are no longer accessible in Clay as of June 2026 — see [Ocean.io integration](ocean-io-integration-overview.md) for details.
