...
description: Step-by-step guide to registering an external platform as an OAuth client and connecting it to Clay's MCP server via Dynamic Client Registration.
last_synced: 2026-07-31T17:29:59.485Z
---
