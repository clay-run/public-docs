...
MCP (Model Context Protocol) is how Clay connects your workspace to AI tools like ChatGPT, Claude, and Cursor. Clay lets workspace admins set credit limits and monitor usage for team members who access Clay through these platforms.
...
-   **Platforms** — icons indicating which platforms the rep has connected (ChatGPT, Claude, or a combination)
...
There is no generic Clay MCP server URL to enter manually.
