...
description: Learn how to run three go-to-market plays—sourcing your addressable market, scoring for ICP fit, and routing by score—using the Clay plugin with a coding agent.
last_synced: 2026-09-16T19:06:14.074Z
---
