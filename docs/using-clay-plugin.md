...
description: How to run go-to-market plays — sourcing your addressable market, scoring for ICP fit, and prioritizing and routing accounts — using the Clay plugin from a coding agent.
last_synced: 2026-09-16T20:00:09.705Z
---
