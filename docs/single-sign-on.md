...
Clay's SAML Entity ID and ACS URL are **unique per organization** — there are no universal, shared values across all Clay customers. These org-specific details are generated by WorkOS for your workspace and are available inside the WorkOS setup portal linked in step 2 above.
