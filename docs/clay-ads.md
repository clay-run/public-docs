...
If the match rate Clay displays does not match what you see in LinkedIn Campaign Manager or Meta Ads Manager, duplicate rows in your Clay table are the most common cause.
...
-   **LinkedIn and Meta** deduplicate the submitted list and report their match rate based on unique contacts — the same person appearing in multiple rows is counted once in the platform's calculation.
