...
Clay offers pre-built MCP connectors within each supported platform's app or connector directory — see the [MCP settings guide](https://university.clay.com/docs/mcp-settings) for the full list of supported platforms and setup instructions.
