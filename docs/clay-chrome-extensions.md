...
**Note:** Clay for Chrome does not work on LinkedIn. If you want to add contacts from LinkedIn profiles or LinkedIn Sales Navigator to your Clay tables, use the [Clip to Clay extension](https://chromewebstore.google.com/detail/clip-to-clay/peaelamodldoacgjbgemamnljcjehiif) instead.
