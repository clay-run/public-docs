...
**Note:** Clay for Chrome does not work on professional networking sites, including LinkedIn and LinkedIn Sales Navigator — if you try, you'll see the message "The Clay Chrome extension is not available on LinkedIn." To capture contacts from LinkedIn profiles, use the [Clip to Clay extension](clip-to-clay-extension.md) instead — it adds a one-click button on LinkedIn profile pages and runs enrichments automatically once a person is added to your table. For other professional networking workflows, [Exportly](https://www.exportly.ai/) is a Clay partner extension built for professional networking.
