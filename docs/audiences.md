...
To inspect row-level results, click `⋮` on any enrichment card and select **Open enrichment**. This opens the underlying bulk enrichment table where you can see each row's output and status.
