...
-   **You want to sync contacts to an ad platform (LinkedIn, Meta)** — Audiences is the recommended path for Clay Ads (currently in beta on Growth and Enterprise plans — contact your Growth Strategist if you don't see the option). Table-based ad syncs are labeled Legacy in the product and being phased out in favor of Audiences-based syncs.
