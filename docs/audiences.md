...
1.  **Contacts without hashed emails:** Filter to rows where the custom hashed email column is empty, then enable Enhanced Matching (**Premium** or **Standard**) so Clay finds and exports hashed emails for those contacts.
