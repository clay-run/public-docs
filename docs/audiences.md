...
-   Google Ads is only available for audiences sourced from first-party data (your own CRM or data warehouse), and requires workspace enablement (currently in beta — contact your Growth Strategist or [Clay support](https://www.clay.com/contact) to enable it). If your audience uses Clay's company/people search (CPJ) data, Google Ads will not be available to add.
