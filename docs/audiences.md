---
title: Audiences
description: "Clay Audiences is available on Growth and Enterprise plans. Launch workspaces can import via CSV, people/company search, and Clay table sends; connecting a CRM or data warehouse requires Growth or above. Legacy plan customers are receiving temporary Audiences access through January 2027 (currently rolling out — contact support if not yet visible in your workspace)."
last_synced: 2026-08-20T01:53:27.941Z
---

# Audiences

**Plan availability:** Clay Audiences is available on **Growth** and **Enterprise** plans (including legacy Enterprise). Launch workspaces have access to core Audiences features — importing via CSV, people/company search, and Clay table sends — but connecting a CRM or data warehouse as a data source requires **Growth or above**. **Legacy plan customers are receiving temporary access to Audiences through January 2027 (currently rolling out — contact support if you don't see it in your workspace yet):** legacy **Pro** plan workspaces receive Growth-equivalent access (CRM and data warehouse connections supported, up to 250,000 imported records); legacy **Starter**, **Basic**, and **Explorer** plan workspaces receive Launch-equivalent access (CSV, people/company search, and Clay table imports only — no CRM or data warehouse connections). After January 2027, legacy plan access reverts to a limited free tier. Free and Trial workspaces do not have access to Audiences. Growth plans can sync up to 250,000 CRM/DWH records; Enterprise plans support up to 25,000,000 records. Only imported Account, Contact, and Lead records count toward this limit — Activities (Salesforce Tasks and Events) and Opportunities associated with those accounts do not count toward the record limit.
