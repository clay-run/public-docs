...
For organizational-level budget governance — grouping resources under named budgets and tracking spend across teams — see [Credit budgeting](/docs/credit-budgeting).
