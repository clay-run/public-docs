...
1.  **Filter the function column by "has results."** Click **Filters** in the table toolbar, select the function column as the field, and choose **has results** from the status dropdown. This surfaces every row where the function ran and returned data successfully.
