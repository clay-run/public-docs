...
### How do I get a standard LinkedIn profile URL from a Sales Navigator profile URL?

Pass your Sales Navigator person profile URL as the **Professional URL** input to **Enrich Person**. Enrich Person accepts Sales Navigator profile URLs (`https://www.linkedin.com/sales/people/...`) in addition to standard LinkedIn profile URLs — see the [valid inputs listed in the troubleshooting section](#getting-invalid-input-invalid-person-identifier-from-enrich-person). Clay resolves the Sales Navigator ID and returns the standard `linkedin.com/in/` profile URL in the enrichment output.
