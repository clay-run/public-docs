...
3.  Under `Sync destinations`, add the ad platform and authenticate when prompted. Grant Clay permission to create and manage matched audiences.
...
Match rates depend heavily on which identifiers you send. Work emails alone typically match 60–70%. Running `Enhanced matching` to add hashed personal emails typically takes that to 90–95% on this platform.
...
### My audience size in the platform is larger than the number of contacts I sent. Why?
