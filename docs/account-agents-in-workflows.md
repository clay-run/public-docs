...
description: How to add an Account Agent as a node inside a workflow so the agent uses the account's full Audiences history to decide the next action.
last_synced: 2026-08-25T01:19:30.704Z
---
