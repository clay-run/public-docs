...
description: Configure IP allowlists to restrict which IP addresses can access your Clay workspace from the web app and API, available on the Enterprise plan.
last_synced: 2026-09-22T20:17:23.005Z
---
...
4.  Under `IP addresses`, enter one IPv4 address, IPv6 address, or CIDR range per line.
